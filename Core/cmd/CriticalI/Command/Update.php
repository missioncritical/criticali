 ...
 */
class CriticalI_Command_Update_Listener implements CriticalI_Package_StatusListener {
...
, array(
  ...
  new CriticalI_OptionSpec('verbose', CriticalI_OptionSpec::NONE, null, 'Displays additional information as the update progresses.'),
  ...
  protected function run_command() {
    ...
    $status = new CriticalI_Command_Update_Listener();
